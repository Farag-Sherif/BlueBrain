...
export default function ProjectDetails() {
  ...
  return (
    <div className="bg-[var(--surface-alt)] min-h-screen" dir={lang === "ar" ? "rtl" : "ltr"}>
      
      {/* ─── HERO SECTION ─── */}
      <section className="relative min-h-[50vh] md:min-h-[60vh] flex items-end overflow-hidden">
        {/* Background Cover Image */}
        <img
          src={project.image_cover || project.image}
          alt={project.title}
            ...
            <div className="flex flex-col md:flex-row items-end md:items-center gap-8">
              ...
              {project.image && (
                <div className="w-24 h-24 md:w-28 md:h-28 rounded-2xl bg-white/10 backdrop-blur-md border border-white/15 p-4 flex items-center justify-center shadow-2xl shrink-0">
                  <img src={project.image} alt={project.client} className="w-full h-full object-contain" />
                </div>
              )}
              
              <div className="flex-1">
                {/* Status Badge */}
                <span className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold border backdrop-blur-md mb-4 ${
            ...
            <div className="flex items-center gap-3 flex-wrap">
              {project.link && (
                ...
                >
                  ...
                  {p.viewWebsite || (lang === "ar" ? "زيارة الموقع" : "Visit Website")}
                </a>
              )}
              {downloadableFile && (
                <button
        ...
        <ScrollReveal variant="fadeUp" delay="0ms">
          <div className="container mx-auto px-4 mb-20">
            <div className="flex items-center gap-4 mb-10">
              ...
              <span className="text-slate-400 text-sm font-semibold">{videos.length}</span>
            </div>
            <Carousel>
              {videos.map((v, i) => (
                <VideoCard
            ...
            <div className="flex items-center gap-4 mb-10">
              <div className="w-10 h-10 rounded-xl bg-blue-600 flex items-center justify-center shadow-md">
                <svg className="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 15.75l5.159-5.159a2.25 2.25 0 013.182 0l5.159 5.159m-1.5-1.5l1.409-1.409a2.25 2.25 0 013.182 0l2.909 2.909M3.75 21h16.5a2.25 2.25 0 002.25-2.25V6.75a2.25 2.25 0 00-2.25-2.25H3.75A2.25 2.25 0 001.5 6.75v11.25A2.25 2.25 0 003.75 21z" />
                </svg>
              </div>
              <h2 className="font-display text-3xl md:text-4xl font-bold text-slate-800">
                {p.designsTitle}
              ...
              <div className="flex-1 h-px bg-slate-200 ml-4 rtl:mr-4 rtl:ml-0"></div>
              <span className="text-slate-400 text-sm font-semibold">{images.length}</span>
            </div>
            <Carousel>
              {images.map((img, i) => (
                <div
